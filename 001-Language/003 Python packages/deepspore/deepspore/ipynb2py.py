...
def extract_save_blocks(ipynb_path:str, output_py_path:str) -> None:
    '''
    Collect code blocks started with "#@save" in ipynb format file to one file named with utils.py.
    Args:
        ipynb_path: str
        output_py_path: str
...
def ipynb2(ipynb_file:str, label:str, output_file:str) -> None:
    ...
    # Demo
    >>> extract_save_blocks('learn_PyTorch.ipynb', '#@save', 'utils/utils.py')
    '''
