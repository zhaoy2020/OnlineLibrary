...
class BrainDQNMain(object):
    ...
    def train(self): # Step 1: obtain random minibatch from replay memory
        ...
        # ++++++++++++++++++++++++++++++++++++++++++
        QValue_batch = self.Q_netT(nextState_batch.to(device))
        ...
        # +++++++++++++++++++++++++++++++++++++
        y_predict=self.Q_net(state_batch_tensor.to(device)).gather(1, action_batch_tensor.to(device))
        # +++++++++++++++++++++++++++++++++++++
        loss=self.loss_func(y_predict, y_batch_tensor.to(device))
    ...
    def getAction(self):
        ...
        # ++++++++++++++++++++++++++++++++++++++++++
        QValue = self.Q_net(currentState.to(device))[0]
